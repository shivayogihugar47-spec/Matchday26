  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/70 backdrop-blur-2xl">
      <div className="mx-auto max-w-7xl px-3 py-3 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[1.8rem] border border-white/10 bg-white/5 px-3 py-3 sm:px-4 sm:py-4 shadow-[0_25px_90px_rgba(2,6,23,0.4)] backdrop-blur-xl">
          ...
          <div className="relative z-10 flex flex-wrap items-center justify-between gap-2 sm:gap-3">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              >
                <img src="/logo.png" alt="MatchDay 26 Logo" className="h-14 w-14 sm:h-16 lg:h-20 w-auto object-contain" />
              </motion.div>
              <div>
                <h1 className="font-display text-xl sm:text-2xl font-extrabold tracking-tight bg-gradient-to-r from-lime-300 via-yellow-300 to-sky-400 bg-clip-text text-transparent lg:text-3xl">
                  MatchDay 26
                </h1>
                <p className="mt-0.5 text-[10px] sm:text-xs text-slate-400 lg:text-sm">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              <motion.button
                ...
                className={`flex items-center gap-1 sm:gap-2 rounded-xl px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-white transition-all shadow-[0_10px_25px_rgba(2,6,23,0.22)] ${
              ...
              >
                {isConnecting ? <Activity className="h-3 w-3 sm:h-4 sm:w-4 text-white animate-spin" /> : 
                 callActive ? <MicOff className="h-3 w-3 sm:h-4 sm:w-4 text-white" /> : 
