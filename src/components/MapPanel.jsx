...
const MapPanel = () => (
  <TicketCard className="flex w-full flex-col gap-5">
    ...
    <div className="h-80 overflow-hidden rounded-[1.5rem] border border-white/10 shadow-md">
      <MapContainer center={METLIFE_STADIUM} zoom={16} style={{ height: '100%', width: '100%' }}>
        ...
        <Marker position={METLIFE_STADIUM}>
          <Popup>
            <div className="rounded-xl bg-gradient-to-br from-blue-900/95 to-green-900/95 p-3 text-white">
              ...
              <p className="text-xs font-semibold text-neutral-300">FIFA World Cup 2026 Venue</p>
            </div>
          </Popup>
        </Marker>
      </MapContainer>
